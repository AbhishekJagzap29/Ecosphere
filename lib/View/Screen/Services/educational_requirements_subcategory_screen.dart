...
class EducationalRequirementsSubcategoryScreen extends StatelessWidget {
  const EducationalRequirementsSubcategoryScreen({super.key});
  ...
  Widget build(BuildContext context) {
    final subcategories = [
      ...
      },
      {
        ...
        'description': 'Kindergarten and preschool programs',
      },
      {
      ...
      },
      {
        ...
        'title': 'Diploma & Graduation Colleges',
        'color': const Color(0xFFF57C00),
        'description': 'Undergraduate and diploma programs',
      },
      {
